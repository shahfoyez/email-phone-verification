; (function ($) {
    ...
    $(document).on('ready', function () {
        ...
        //
        //     // Function to determine if autoplay should be enabled
        //     const shouldAutoplay = () => {
        //         const totalWidth = $slider.get(0).scrollWidth; // Total width of all items
        //         const visibleWidth = $slider.outerWidth(); // Visible width of the slider container
        //         return totalWidth > visibleWidth; // Autoplay only if content exceeds visible width
        //     };
        //
        //     // Initialize Slick slider with dynamic autoplay
        //     $slider.slick({
        //         dots: false,
        //         arrows: true,
        //         prevArrow: '<button class="slick-prev" type="button"><i class="fa fa-angle-left"></i></button>',
        //         nextArrow: '<button class="slick-next" type="button"><i class="fa fa-angle-right"></i></button>',
        //         infinite: false,
        //         autoplay: shouldAutoplay(), // Enable autoplay conditionally
        //         autoplaySpeed: 3000,
        //         slidesToScroll: 1,
        //         variableWidth: true,
        //         responsive: [
        ...
        //     });
        //
        //     // Function to show/hide arrows based on content width
        //     const checkArrowVisibility = () => {
        //         const totalWidth = $slider.get(0).scrollWidth; // Total width of all items
        //         const visibleWidth = $slider.outerWidth(); // Visible width of the slider container
        //
        //         if (totalWidth > visibleWidth) {
        //             $('.slick-prev, .slick-next').show(); // Show arrows if content exceeds visible area
        //         } else {
        //             $('.slick-prev, .slick-next').hide(); // Hide arrows if all items fit in the visible area
        //         }
        //     };
        //
        //     // Run the check after Slick initializes and on window resize
        //     $slider.on('init', checkArrowVisibility);
        //     $(window).on('resize', function () {
        //         checkArrowVisibility();
        //         // Dynamically toggle autoplay based on content
        //         const autoplay = shouldAutoplay();
        //         if (autoplay && !$slider.slick('slickGetOption', 'autoplay')) {
        //             $slider.slick('slickSetOption', 'autoplay', true, true);
        //         } else if (!autoplay && $slider.slick('slickGetOption', 'autoplay')) {
